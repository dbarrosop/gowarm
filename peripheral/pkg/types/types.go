...
var (
	...
	// 6AAFC52E-73B9-44D8-AC40-CE44D2EE95A1
	CharacteristicUUIDResetAttempt = bluetooth.NewUUID([16]byte{0x6A, 0xAF, 0xC5, 0x2E, 0x73, 0xB9, 0x44, 0xD8, 0xAC, 0x40, 0xCE, 0x44, 0xD2, 0xEE, 0x95, 0xA1})
)
